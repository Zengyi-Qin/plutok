...
from plutok.openvoice import modules
from plutok.openvoice import attentions

from torch.nn import Conv1d, ConvTranspose1d, Conv2d
from torch.nn.utils import weight_norm, remove_weight_norm, spectral_norm

from plutok.openvoice.commons import init_weights, get_padding
...
class SynthesizerTrn(nn.Module):
    ...
    def get_embedding(self, y, y_lengths, sid_src, sid_tgt, tau=1.0):
        g_src = sid_src
        g_tgt = sid_tgt
        z, m_q, logs_q, y_mask = self.enc_q(
            y,
